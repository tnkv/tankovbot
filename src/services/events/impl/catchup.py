...
catchup_events = [
    ConditionEvent(
        ...
        text="💻 Критический баг Вселенной: значение твоего кока ушло так глубоко в минус, что пробило дно памяти и обнулилось с другой стороны! Движок выдал тебе полную перезагрузку!",
        priority=100
    ),
    ConditionEvent(
    ...
    ConditionEvent(
        ...
        chance_percent=15.0,
        action=300,
        text="💎 ROCK AND STONE! Гномы копали глубоко в шахте и случайно наткнулись на твой ствол. Откопали сокровище!",
        priority=98
    ),
    ConditionEvent(
        name="Эффект Рогатки",
        ...
        text="🏹 Чем сильнее оттягиваешь резинку, тем мощнее выстрел! Твоя гигантская впадина выстрелила наружу с бешеной скоростью! Полная инверсия!",
        priority=97
    ),
    ConditionEvent(
        ...
        chance_percent=10.0,
        action=150,
        text="🛠️ Ты заехал на эстакаду, и мужики поддомкратили твою вмятину пневматикой. Нехилый буст, с тебя бутылка!",
        priority=96
    ),
    ConditionEvent(
        name="Белая Дыра",
    ...
    ConditionEvent(
        ...
        text="🚁 Соседи вызвали спасателей, услышав твой плач. МЧС пригнали лебедку, зацепили то, что осталось, и вытянули наружу. Больше не болей.",
        priority=94
    )
]
